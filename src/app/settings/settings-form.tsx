  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">Here are the files uploaded to your account.</p>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete the file uploaded{" "}
                            {formatDistanceToNow(new Date(file.uploadedAt), {
                              addSuffix: true
                            })}
                            .
...
interface SettingsFormProps {
  ...
  tab: "account" | "customization" | "memory" | "attachments";
}
